  ...
  return (
    <MerchantLayout>
      ...
      <div className='flex flex-wrap justify-center items-center mt-5'>
        ...
        <div className='w-[350px] bg-slate-400 rounded-md px-5 py-2 mr-5 mt-5'>
          <h4 className='font-semibold text-[32px]'>Revenue</h4>
          <p className='font-semibold text-[24px]'>560M</p>
        </div>
        <div className='w-[350px] bg-slate-400 rounded-md px-5 py-2 mr-5 mt-5'>
          <h4 className='font-semibold text-[32px]'>Total Order</h4>
          <p className='font-semibold text-[24px]'>560M</p>
        </div>
        <div className='w-[350px] bg-slate-400 rounded-md px-5 py-2 mr-5 mt-5'>
          <h4 className='font-semibold text-[32px]'>Best selling product</h4>
          <p className='font-semibold text-[24px]'>560M</p>
        </div>
      </div>
    </MerchantLayout>
